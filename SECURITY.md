...
This repository was created using [Atlantis Starter #00](https://github.com/63Klabs/atlantis-starter-00-basic-apigw-lambda-nodejs) as a template.

### Starter Code

If a developer using the Starter finds a **vulnerability in the code or configuration provided by the starter**, they are encouraged to report it using the [Security and quality](https://github.com/63Klabs/atlantis-starter-00-basic-apigw-lambda-nodejs/security) section of the original GitHub repository.
